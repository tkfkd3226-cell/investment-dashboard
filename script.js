  ...
  const groups=[
    ...
    },
    {
      ...
      items:[
        ...
        {id:'pension-investment-analysis',icon:'📊',title:'투자 기간 분석',desc:'퇴직연금 기준'},
    ...
    },
    {
      ...
      items:[
        ...
        {id:'investment-analysis',icon:'📊',title:'투자 기간 분석',desc:'증권계좌 기준'},
        ...
        {id:'ledger-check',icon:'🔍',title:'장부상 결과물 VS 실제 보유액',desc:'실제 잔고 검산'},
...
function renderCharts(x){
  ...
  return `<section id="investment-analysis"><div class="section-title"><h2><span class="section-title-icon">📊</span>투자 기간 분석</h2><p>삼성증권 계좌1 기준</p></div><div class="grid chart-grid">
...
function renderPensionCharts(x){
  ...
  return `<section id="pension-investment-analysis" class="pension-chart-block"><div class="section-title"><h2><span class="section-title-icon">📊</span>투자 기간 분석</h2><p>퇴직연금 기준</p></div><div class="grid chart-grid">
