...
function setupDashboardEventDelegation(){
  ...
  document.addEventListener('keydown',event=>{
    ...
    const heroBasis=event.target.closest?.('[data-dashboard-action="hero-basis-tap"]');
    if(heroBasis){
